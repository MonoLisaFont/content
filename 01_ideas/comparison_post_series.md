...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MonoLisa | Measured locally | 591 publishable measured | Latin 496, Cyrillic 88, Hebrew 5, Greek 2; Armenian planned | Yes | Yes | Yes | Yes | Yes | Yes; `ss02`-`ss15` measured | Yes; `cv01`-`cv12` measured | Yes, MonoLisa Text | Yes | `zero` feature measured | Yes | Yes | Yes; hhea/OS/2 typo/win metrics align in v3.000 | Measured from MonoLisaCode v3.000: 2105 glyphs, 1784 cmap entries, Hyperglot 591 publishable languages, Powerline 6/6, box drawing 128/128, block elements 32/32. |
