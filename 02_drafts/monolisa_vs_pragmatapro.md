...
Deferred until PragmataPro can be inspected from a licensed file or documented from a permitted public source. Keep claims about ligatures, stylistic sets, and character variants as unverified until then.
...
Deferred until PragmataPro style files, trial terms, or official specimen permissions are available.

MonoLisa Code measured as variable upright and italic files with 10 named weights: Hairline, Thin, ExtraLight, Light, Regular, Medium, SemiBold, Bold, ExtraBold, and Black. PragmataPro's weight count still needs edition-by-edition verification from a licensed file, trial file, or permitted public source.
...
Deferred commercial-font comparison. PragmataPro needs edition-by-edition license/trial review before this post can use measured data or rendered specimens. Do not render or publish specimen graphics from the commercial font unless the license or written permission allows public comparison use.

## Source links

- [MonoLisa](https://www.monolisa.dev/)
- [PragmataPro page](https://fsd.it/shop/fonts/pragmatapro/)
...
| Category | MonoLisa Code | PragmataPro |
| --- | --- | --- |
...
| **Fixed weights** | 10 | Needs verification by edition |
| **Variable axes** | 2 (`wght`, `GRAD`) | Needs verification by edition |
| **Style control** | 15 stylistic sets, 12 character variants | Needs verification |
| **Coding ligatures** | <span style={{ color: "var(--ml-colors-primary, currentColor)" }}>Yes</span> | Yes in full versions; verify by edition |
| **Terminal symbols** | <span style={{ color: "var(--ml-colors-primary, currentColor)" }}>Yes</span> | Needs licensed-font measurement |
| **Proportional counterpart** | <span style={{ color: "var(--ml-colors-primary, currentColor)" }}>Yes</span>, MonoLisa Text | PragmataPro / PragmataPro Mono variants |
