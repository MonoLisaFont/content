...
Agentic tools come with risks of their own and some call [AI brain fry](https://hbr.org/2026/03/when-using-ai-leads-to-brain-fry) a concrete problem so it's possible to overdo it. The introduction of agentic tools is comparable to the introduction of motorsaw since now we can work much faster while also doing a lot of damage if we don't understand well what we are doing.
